module github.com/team-monolith-product/image-locality-filter
...
replace (
	...
	k8s.io/cri-streaming => k8s.io/cri-streaming v0.33.0
	...
	k8s.io/streaming => k8s.io/streaming v0.33.0
)
